...
<script type="text/javascript">
    function ajaxsplit(page) {
        ...
        //异步ajax分页请求
        $.ajax({
        url:"${pageContext.request.contextPath}/prod/ajaxsplit.action", //url:远程服务器端的地址
            data:{"page":page,"pname":pname,"typeid":typeid,"lprice":lprice,"hprice":hprice}, //要提交的数据，提交的数据的名称叫做page,之后在控制器接的参数为page
            type:"post",
